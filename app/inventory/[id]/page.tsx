...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
    ...
    return {
        ...
        openGraph: {
            title: `${titleStr} | Bristol Used Cars`,
...
export default async function CarDetailsPage({ params }: Props) {
    ...
    const jsonLd = {
        ...
        offers: {
            ...
            url: `https://bristolusedcars.co.uk/inventory/${vehicle.id}`,
            seller: {
                "@type": "AutoDealer",
                name: "Bristol Used Cars",
                address: {
                    "@type": "PostalAddress",
                        ...
                        <div className="flex flex-col">
                            ...
                            <div className="bg-[#f7f7f7] border border-gray-200 rounded-2xl p-6 mb-6 shadow-sm relative overflow-hidden">
                                ...
                                <div className="flex flex-col gap-3">
                                    ...
                                    <a
                                        href={`https://wa.me/447441906211?text=${whatsappMessage}`}
                                        target="_blank"
                            ...
                            <div className="flex items-start gap-4 bg-[#ebf0fe] border border-[#1e3a8a]/20 rounded-xl p-5 mb-8">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-600 text-sm mt-1">
                                        Spread the cost with flexible finance options. Call us or WhatsApp to discuss what works for you — no obligation.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="mb-8">
                                ...
                                <address className="not-italic text-gray-700 bg-[#f7f7f7] p-6 rounded-xl border border-gray-100">
                                    <strong className="text-gray-900 block mb-1">Bristol Used Cars</strong>
