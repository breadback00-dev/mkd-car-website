...
export const metadata: Metadata = {
    title: "Used Cars for Sale in Bristol",
    description: "Browse our full selection of quality, fully inspected used cars for sale in Bristol. Filter by fuel type, body type, and price. All cars are HPI checked.",
    openGraph: {
        title: "Used Cars for Sale in Bristol | MKD Cars",
        ...
        <div className="bg-[#f7f7f7] min-h-[80vh] py-16 px-4 sm:px-6 lg:px-8">
            <div className="max-w-7xl mx-auto">
                <div className="mb-10 border-b border-gray-200 pb-8">
                    <h1 className="text-4xl font-extrabold tracking-tight text-gray-900 mb-4">Used Cars for Sale in Bristol</h1>
