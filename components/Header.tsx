            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center h-20">
                    ...
                    <nav className="hidden md:flex space-x-10">
                        <Link href="/" className="text-gray-600 hover:text-[#1e3a8a] py-2 font-medium transition-colors">
                            Home
                        </Link>
                        <Link href="/inventory" className="text-gray-600 hover:text-[#1e3a8a] py-2 font-medium transition-colors">
                            Inventory
                        </Link>
                        <Link href="/contact" className="text-gray-600 hover:text-[#1e3a8a] py-2 font-medium transition-colors">
                            Contact
                        </Link>
                    </nav>
